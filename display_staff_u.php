    ...
    while ($row=$result->fetch_assoc())
    {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <form action="update_staff.php" method="post" class="form-group" enctype="multipart/form-data">
                        <input type="number" name="staffid" class="form-control" required value="<?php echo $row["staff_id"];?>">
                        <br>
                        <input type="image" name="staff_photo" value="<?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['staff_photo'] ).'" height="60px" width="80px"/>';?>">
                        <br>
